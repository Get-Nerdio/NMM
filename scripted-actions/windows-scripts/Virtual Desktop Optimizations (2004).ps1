...
mkdir "C:\Windows\temp\NerdioManagerLogs\ScriptedActions\win10optimize2004" -Force
Start-Transcript -Path "C:\Windows\temp\NerdioManagerLogs\ScriptedActions\win10optimize2004\ps_log.txt" -Append
